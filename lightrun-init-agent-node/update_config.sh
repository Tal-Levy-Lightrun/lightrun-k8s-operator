#!/bin/sh
# Script to initialize and configure the Lightrun Node.js agent
# This script:
...
# 5. Copies the final configuration (including the bootstrap script) to destination
...
validate_env_vars() {
    ...
    # Check for LIGHTRUN_SERVER (required)
